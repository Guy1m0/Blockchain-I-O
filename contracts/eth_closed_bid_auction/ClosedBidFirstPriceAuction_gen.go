...
func (_EthClosedBidAuction *EthClosedBidAuctionCaller) CheckAverageScore(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _EthClosedBidAuction.contract.Call(opts, &out, "checkAverageScore")
...
//
// Solidity: function checkAverageScore() view returns(int256)
func (_EthClosedBidAuction *EthClosedBidAuctionSession) CheckAverageScore() (*big.Int, error) {
	return _EthClosedBidAuction.Contract.CheckAverageScore(&_EthClosedBidAuction.CallOpts)
}

// CheckAverageScore is a free data retrieval call binding the contract method 0xdad23936.
//
// Solidity: function checkAverageScore() view returns(int256)
func (_EthClosedBidAuction *EthClosedBidAuctionCallerSession) CheckAverageScore() (*big.Int, error) {
	return _EthClosedBidAuction.Contract.CheckAverageScore(&_EthClosedBidAuction.CallOpts)
}
...
func (_EthClosedBidAuction *EthClosedBidAuctionTransactor) Create(opts *bind.TransactOpts, _asset_id string) (*types.Transaction, error) {
	return _EthClosedBidAuction.contract.Transact(opts, "create", _asset_id)
}

// Create is a paid mutator transaction binding the contract method 0xb6a46b3b.
//
// Solidity: function create(string _asset_id) returns()
func (_EthClosedBidAuction *EthClosedBidAuctionSession) Create(_asset_id string) (*types.Transaction, error) {
	return _EthClosedBidAuction.Contract.Create(&_EthClosedBidAuction.TransactOpts, _asset_id)
}

// Create is a paid mutator transaction binding the contract method 0xb6a46b3b.
//
// Solidity: function create(string _asset_id) returns()
func (_EthClosedBidAuction *EthClosedBidAuctionTransactorSession) Create(_asset_id string) (*types.Transaction, error) {
	return _EthClosedBidAuction.Contract.Create(&_EthClosedBidAuction.TransactOpts, _asset_id)
}
...
func (_EthClosedBidAuction *EthClosedBidAuctionTransactor) ProvideFeedback(opts *bind.TransactOpts, auctionId *big.Int, _score *big.Int, _feedback [32]byte) (*types.Transaction, error) {
...
//
// Solidity: function provide_feedback(uint256 auctionId, int256 _score, bytes32 _feedback) returns()
func (_EthClosedBidAuction *EthClosedBidAuctionSession) ProvideFeedback(auctionId *big.Int, _score *big.Int, _feedback [32]byte) (*types.Transaction, error) {
...
//
// Solidity: function provide_feedback(uint256 auctionId, int256 _score, bytes32 _feedback) returns()
func (_EthClosedBidAuction *EthClosedBidAuctionTransactorSession) ProvideFeedback(auctionId *big.Int, _score *big.Int, _feedback [32]byte) (*types.Transaction, error) {
	return _EthClosedBidAuction.Contract.ProvideFeedback(&_EthClosedBidAuction.TransactOpts, auctionId, _score, _feedback)
}
