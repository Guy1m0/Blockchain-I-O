...
func TestFabricToken() {
	...
	token1 := ecomm.NewChaincode("token1")
...
func TestFabricAMM() {
	...
	token1 := ecomm.NewChaincode("token1")
	token2 := ecomm.NewChaincode("token2")
	amm1 := ecomm.NewChaincode("amm1")
